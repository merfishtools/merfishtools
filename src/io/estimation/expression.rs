...
impl<W: io::Write> Writer<W> {
    pub fn from_writer(w: W) -> Self {
        ...
        writer.inner.write(["cell", "feat", "expr_ev", "expr_sd", "expr_ci_lower", "expr_ci_upper"].iter()).unwrap();

        writer
    }

    pub fn write(&mut self, cell: &str, feature: &str, expected_value: f64, standard_deviation: f64, credible_interval: (f32, f32)) {
        self.inner.write([
            cell,
            feature,
